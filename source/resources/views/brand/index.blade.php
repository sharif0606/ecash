								...
								<div class="row">
									<div class="col-sm-12">
										<table class="table table-striped text-center table-bordered dt-responsive dataTable">
											...
											<tbody>
											    @if(count($allBrand))
													@foreach($allBrand as $count=>$brand)
												<tr role="row">
													<td>{{++$count}}</td>
													<td>
                										<div class="d-flex flex-column">
                											<span class="fw-bolder mb-25">{{$brand->name}}</span>
                										</div>
                									</td>
													<td>
                										<div class="d-flex flex-column">
                											<span class="fw-bolder mb-25"><img src="{{asset('/')}}storage/images/brand/{{$brand->logo}}" alt="" class="img-thumbnail thumb-sm mr-1" width="100px"> </span>
                										</div>
                									</td>
                									<td>
                										<div class="d-flex flex-column">
                									...
                									<td>
                										...
                										<div class="dropdown">
                											...
                											<div class="dropdown-menu" style="">
                    											<a class="dropdown-item" href="{{route(currentUser().'.editBrand',[encryptor('encrypt', $brand->id)])}}">
                    												<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 me-50"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                    												<span>Edit</span>
                    											</a>
                    											 @if($brand->products->count() <= 0)
                    											<a class="dropdown-item"  onclick="return confirm('Are you sure to delete?')" href="{{route(currentUser().'.deleteBrand', [encryptor('encrypt', $brand->id)])}}">
