                ...
                <div class="auth-inner py-2">
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <p class="card-text mb-2">Please sign-up and start the adventure</p>
                            
                            <form class="auth-login-form mt-2" action="{{ route('signUp') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <input
                                    type="text"
                                    class="form-control @if($errors->has('fullName')) {{'is-invalid'}} @endif" id="fullName" placeholder="Full Name"
                                    name="fullName"
                                ...
                                <input
                                    type="email"
                                    class="form-control @if($errors->has('email')) {{'is-invalid'}} @endif" id="email" placeholder="Email Address"
                                    name="email"
					            ...
					            <button type="submit" class="btn btn-primary w-100">Regestration</button>
