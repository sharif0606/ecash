...
<div class="content-wrapper container-xxl p-0">
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Product Add</h2>
	...
	<div class="card">
	<!--begin::Form-->
	 <form class="form" action="{{ route(currentUser().'.addNewProduct') }}" method="POST" enctype="multipart/form-data">
		@csrf
		...
		<div class="card-body">
			...
			<div class="form-group row">
				<div class="col-lg-4 mb-1">
					...
					<input type="text" name="name" value="{{ old('name') }}" class="form-control @if($errors->has('name')) {{ 'is-invalid' }} @endif" placeholder="Brand name" />
					@if($errors->has('name'))
					<small class="d-block text-danger mb-3">
						{{ $errors->first('name') }}
					</small>
				...
				<div class="col-lg-4 mb-1">
					...
					<input type="text" name="serialNo" value="{{ old('serialNo')}}" class="form-control  @if($errors->has('serialNo')) {{ 'is-invalid' }} @endif" placeholder="Serial No" />
			...
			<div class="form-group row">
				<div class="col-lg-4 mb-1">
					...
					<input type="text" name="modelName" class="form-control" value="{{old('modelName') }}" />
				</div>
				<div class="col-lg-4 mb-1">
					<label> Model No:  </label>
					<input type="text" name="modelNo" class="form-control" value="{{old('modelNo') }}" />
				</div>
				<div class="col-lg-4 mb-1">
					<label> Warrenty:  </label>
					<input type="text" name="warrenty" class="form-control" value="{{old('warrenty') }}" />
				</div>
			</div>
