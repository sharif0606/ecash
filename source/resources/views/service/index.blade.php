				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4 class="card-title">
								All Service List Here...
							</h4>
							<div class="d-flex justify-content-end">

								<a href="{{route(currentUser().'.addNew_ServiceForm')}}"
									class="btn btn-primary font-weight-bolder  waves-effect waves-float waves-light">
									<i class="la la-list"></i>New Service</a>
							...
							<div class="table-responsive">
								<div id="myTable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
									<div class="row">
													...
													<tr role="row">
														...
														<td>
															<div
																...
																<div><span class="fw-bolder">Service No:</span>{{ $company->shopCode }}-{{date('y')}}-{{ str_pad($service->id,8,'0',STR_PAD_LEFT) }}<span>
																		</div>
																<div><span class="fw-bolder">Product Details:</span><span>
																		{{$service->product_detl}}</div>
																<div><span class="fw-bolder">Receive Date:</span><span>
																		{{$service->receive_date}}</div>
										...
										<a class="dropdown-item" href="{{route(currentUser().'.serviceShow',[encryptor('encrypt', $service->id)])}}">
