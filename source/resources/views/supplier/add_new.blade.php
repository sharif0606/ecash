...
<div class="content-wrapper container-xxl p-0">
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Supplier Add</h2>
    ...
    <div class="card card-custom gutter-b example example-compact">
        <!--begin::Form-->
        <form class="form" action="{{ route(currentUser().'.addNewSupplier') }}" method="POST">
        @csrf
        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-lg-4 mb-1">
                    ...
                    <input type="text" name="supCode" value="{{ old('supCode') }}" class="form-control @if($errors->has('supCode')) {{ 'is-invalid' }} @endif" placeholder="Supplier Code" />
                    @if($errors->has('supCode'))
                        <small class="d-block text-danger mb-3">
                            {{ $errors->first('supCode') }}
                        </small>
                    @endif
                </div>
                <div class="col-lg-8 mb-1">
                    <label>Supplier Name: <span class="text-danger sup">*</span></label>
                    <input type="text" name="name" value="{{ old('name') }}" class="form-control @if($errors->has('name')) {{ 'is-invalid' }} @endif" placeholder="Supplier Name" />
                    @if($errors->has('name'))
                        <small class="d-block text-danger mb-3">
                            {{ $errors->first('name') }}
                        </small>
