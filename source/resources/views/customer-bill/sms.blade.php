                        ...
                        <div class="card-body">
                            ...
                            <form class="mt-2" action="{{route('cus_verify_sms')}}" method="POST">
								...
								<div class="form-group">
                                    <div id="phoneInput">
                                        <div class="field-wrapper">
                                            <div class="phone">
                                                @if($user)
												<input type="hidden" name="mobileNumber" value="{{$user->custCode}}">
												@endif
                                ...
                                <p class="mt-1 text-center">@lang('If not found, you can')
                                    <a class="text-danger" href="{{route('cus_send_verify_code',$user->custCode)}}?type=phone">@lang('Resend code')</a>
                                </p>
                                @endif
                                <div class="form-group">
