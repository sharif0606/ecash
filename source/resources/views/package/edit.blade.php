...
<div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
          <div class="col-12">
            <h2 class="content-header-title float-start mb-0">Package Edit</h2>
	...
	<div class="card">
		...
		<!--begin::Form-->
		<form class="form" action="{{ route(currentUser().'.updatePackage') }}" method="POST">
			@csrf
			<input type="hidden" value="{{ Session::get('user') }}" name="userId">
			<input type="hidden" value="{{ encryptor('encrypt', $package->id) }}" name="id">
            <div class="card-body">
				<div class="form-group row">
					<div class="col-lg-4">
						<label>Package Name  <small class="text-danger font-13">*</small></label>
                        <input type="text" name="packageName" value="{{ $package->name }}" class="form-control @if($errors->has('packageName')) {{ 'is-invalid' }} @endif" placeholder="Package Name" />
					...
					<div class="col-lg-4">
                        ...
                        <input type="text" name="packageCode" value="{{ $package->code }}" class="form-control @if($errors->has('')) {{ 'is-invalid' }} @endif" placeholder="Package Code" />
					...
					<div class="col-lg-4">
						<label>Price</label>
                        <input type="text" name="price" value="{{ $package->price }}" class="form-control" placeholder="00" />
                    </div>
                </div>
				...
				<div class="form-group row">
					<div class="col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control @if($errors->has('duration')) {{ 'is-invalid' }} @endif" name="duration" placeholder="00" value="{{ $package->duration }}">
					...
					<div class="col-lg-4">
						...
						<input type="number" name="canbuy" value="{{ $package->canbuy }}" class="form-control" placeholder="00" />
					</div>
					<div class="col-lg-4">
