...
<section class="invoice-add-wrapper">
	<form action="{{route(currentUser().'.addNewBill')}}" method="POST">
		@csrf
		<div class="row invoice-add">
    		...
    		<div class="col-xl-3 col-md-4 col-12">
    		    <div class="card">
                    <div class="card-body">
                        <p class="mb-50">Do you want to purchase?</p>
                        <a href="{{route(currentUser().'.addNewPurchaseForm')}}" class="btn btn-outline-primary w-100 mb-75 waves-effect">Purchase</a>
                    </div>
                </div>
    		    <div class="card">
                    <div class="card-body">
