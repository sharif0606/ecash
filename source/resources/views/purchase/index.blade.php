				...
				<div class="card">
					<div class="card-header">
						...
						<div class="d-flex justify-content-end">
							<a href="{{route(currentUser().'.addNewPurchaseForm')}}" class="btn btn-primary font-weight-bolder  waves-effect waves-float waves-light">
								<i class="la la-list"></i>New Purchase
							</a>
						</div>
					</div>
					<div class="card-body">
